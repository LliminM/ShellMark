...
public class UserObjectConstraints implements java.io.Serializable {
    ...
    public boolean isAlgoOn(shellmark.Algorithm a) {
    ...
    public void setAlgoOn(shellmark.Algorithm a, boolean isOn) {
    ...
    */
    ...
    private static void collectUserConstraints(shellmark.program.Object obj,
        ...
        while(members.hasNext()){
            shellmark.program.Object child = (shellmark.program.Object)members.next();
    ...
    private static void assignUserConstraints(shellmark.program.Object obj,
                                              java.util.HashMap constraintMap)
    {
