...
public class File extends shellmark.program.JarElement {
	...
	private byte[] data;                 /* file contents */
	    ...
	    */
	   public File(shellmark.program.Application parent, String name, byte[] data) {
	      setName(name);
	      setData(data);
	      parent.add(this);
	   }
	    ...
	    */
	   public File(shellmark.program.Application parent, String name,
	   ...
	   public void setData(java.io.InputStream istream) throws java.io.IOException {
	      this.data = shellmark.util.Misc.loadBytes(istream);
	      mark();
	   }
