...
abstract class ConstantPoolGen extends org.apache.bcel.generic.ConstantPoolGen {
	...
	/**
	    ...
	    */
	   private shellmark.program.Class smclass;



	   /**
	    * Constructs a Shellmark ConstantPoolGen from a BCEL ConstantPool.
	    */
	   ConstantPoolGen(shellmark.program.Class c,
	    ...
	    */
	   shellmark.program.Class getSMClass() {
	      return smclass;
	   }
	    ...
	    * @return index of entry
	    */
	   public int addMethodref(shellmark.program.Method method) {
	      return addMethodref(
	    ...
	    * @return index of entry
	    */
	   public int addInterfaceMethodref(shellmark.program.Method method) {
