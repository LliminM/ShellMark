...
/**
*  The shellmark.Console class presents a graphical interface
*  to the ShellMark system.
   @author     LiMin
   @version 1.0
*/
...
public class Console {
	/**
	    ...
	    */
	    ...
	    public static shellmark.util.ConfigProperties getConfigProperties(){
		    ...
		    String args[][] = {
	            ...
	            sConfigProps = new shellmark.util.ConfigProperties(args,null);
		}
	        return sConfigProps;
	    }
	    
	    /**
	     *  Get the URL for the Help page for Shellmark
