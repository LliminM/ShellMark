...
public class StatisticsRecord
{
    ...
    private shellmark.program.Method[] myMethods;
    ...
    */
    ...
    {
        shellmark.program.Method m = getMethod(methodName);
        if(m ==null)
            return 0;
    ...
    {
        shellmark.program.Method m = null;
   ...
   /**
     ...
     */
    public void setMethods(shellmark.program.Method[] methods)
    {
        myMethods = new shellmark.program.Method[methods.length];
        for(int k=0; k<methods.length; k++)
            myMethods[k] = methods[k];
    }

    // return the shellmark.program.Method object given a String methodName
    private shellmark.program.Method getMethod(String methodName)
    {
    ...
    if(result==null)
        ...
        for(int i = 0; i < result.length; i++) {
            shellmark.program.Method mg = myMethods[i];
   ...
   /**
    ...
    public java.util.List getMethodByteCodes(String methodName)
    {
        ...
        shellmark.program.Method mg = null;
    ...
    public String getMethodByteCodeUsage(String methodName)
    {
        ...
        shellmark.util.InstructionTree iTree = new shellmark.util.InstructionTree();
   ...
   /** 
    ...
    public shellmark.program.Method getMethodEditor(String methodName)
    {
    ...
    {
        shellmark.program.Method meth = this.getMethod(methodName);
        if(meth==null) {
	    ...
	    shellmark.analysis.controlflowgraph.MethodCFG mcfg = 
	        new shellmark.analysis.controlflowgraph.MethodCFG(meth);
	...
	*/
    ...
    public int getNumberOfloops(String methodName)
    {
       ...
       shellmark.program.Method mg = this.getMethod(methodName);
       ...
       shellmark.analysis.controlflowgraph.MethodCFG mcfg =
           new shellmark.analysis.controlflowgraph.MethodCFG(mg, false);
       ...
       if(backedgelist==null)
           ...
           if((backedgelist.size()%2)!=0) {
               System.out.println(" Error in evaluating back edges in method; check shellmark.analysis.controlflowgraph.MethodCFG code ... \n");
               numloopsInMethod=-1;
           }
           else 
