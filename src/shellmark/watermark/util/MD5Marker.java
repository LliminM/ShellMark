...
public class MD5Marker extends BasicBlockMarker {
	   ...
	   private shellmark.program.Class dummyClass;
	   ...
	   public MD5Marker(shellmark.program.Class clazz,
	   ...
	   public final java.util.Iterator recognize(shellmark.analysis.controlflowgraph.BasicBlock b) {
	      return new TrivialIterator(read(b.getInstList()));
	   }

	   public final int getCapacity(shellmark.analysis.controlflowgraph.BasicBlock b) {
	      return 1;
	   }
	   ...
	   static shellmark.program.Method findMethod(shellmark.analysis.controlflowgraph.BasicBlock b) {
	      if (b == null)
		 throw new RuntimeException("null basic block");
	      shellmark.analysis.controlflowgraph.MethodCFG cfg =
		 (shellmark.analysis.controlflowgraph.MethodCFG)(b.graph());
	      if (cfg == null)
	   ...
	   private void mark(shellmark.analysis.controlflowgraph.BasicBlock b,
			     int desiredValue) {
		 ...
		 org.apache.bcel.generic.InstructionTargeter [] targeters =
		     ih.getTargeters();
		 shellmark.program.Method method = findMethod(b);
		 org.apache.bcel.generic.InstructionList il = 
	   ...
	   private String addField(shellmark.program.Class clazz,
				   boolean staticField) {
		 ...
		 qualifiers |= org.apache.bcel.Constants.ACC_STATIC;
	      ...
	      shellmark.program.Field field = 
	          new shellmark.program.LocalField(clazz,qualifiers,
	   ...
	   private int addFieldref(shellmark.analysis.controlflowgraph.BasicBlock b) {
	      shellmark.program.Method method = findMethod(b);
	      int index = 0;
