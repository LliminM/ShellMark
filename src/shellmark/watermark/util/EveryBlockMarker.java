...
public class EveryBlockMarker extends MethodMarker {
	...
	while (i.hasNext()) {
	    shellmark.analysis.controlflowgraph.BasicBlock b = 
		(shellmark.analysis.controlflowgraph.BasicBlock)i.next();
     ...
     */
    public final java.util.Iterator recognize(shellmark.program.Method method) {
     ...
     * @see BasicBlockMarker#getCapacity(shellmark.analysis.controlflowgraph.BasicBlock)
     */
    public final int getCapacity(shellmark.program.Method method) {
	if (marker.capacityIsConstant())
		...
		while (i.hasNext()) {
		    b = (shellmark.analysis.controlflowgraph.BasicBlock)i.next();
