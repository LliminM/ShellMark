...
public abstract class ClusterGraph extends shellmark.util.newgraph.MutableGraph {
	   ...
	   public void randomlyWalkAddingEdges(java.util.ArrayList appNodes,
	      ...
	      allNodes.addAll(wmarkNodes);//合并了appnode和wmarknode
		  ...
		  if(DEBUG)
		      System.out.println
			  ("nextNode: " + 
			   shellmark.analysis.controlflowgraph.ProgramCFG.fieldOrMethodName
			   ((shellmark.analysis.controlflowgraph.MethodCFG)nextNode));
	...
	class CFGComparator implements java.util.Comparator {
	   public int compare(Object o1,Object o2) {
	      String o1Name = 
		  shellmark.analysis.controlflowgraph.ProgramCFG.fieldOrMethodName
		 ((shellmark.analysis.controlflowgraph.MethodCFG)o1);
	      String o2Name = 
		  shellmark.analysis.controlflowgraph.ProgramCFG.fieldOrMethodName
		 ((shellmark.analysis.controlflowgraph.MethodCFG)o2);
