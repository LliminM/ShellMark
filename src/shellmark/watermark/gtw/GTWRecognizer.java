...
class GTWRecognizer implements java.util.Iterator {
	   ...
	   private shellmark.util.ConfigProperties configProperties;

	   public GTWRecognizer(shellmark.program.Application app, 
	                        shellmark.util.ConfigProperties props,
	      ...
	      for(java.util.Iterator classIt = app.classes() ; classIt.hasNext() ; ) {
	         ...
	         for(java.util.Iterator methodIt = clazz.methods() ; methodIt.hasNext() ; ) {
	            ...
	            try {
	               ...
	               shellmark.util.graph.graphview.GraphList.instance().add(gr, "rec.spg." + method.getName());
	               shellmark.util.newgraph.codec.GraphCodec gc =
	            ...
	            } catch(shellmark.util.newgraph.codec.DecodeFailure e) {
	               if (DEBUG)
	   ...
	   public Object next() {
	      ...
	      if (useCRT){
	         try{
	            ...
	            mark = 
	               new shellmark.util.splitint.SlowCRTSplitter(128,50,w).combine
	         ...
	         try {
	            mark = (new shellmark.util.splitint.PartialSumSplitter()).combine
	               ((java.math.BigInteger[])wmParts.toArray
	                (new java.math.BigInteger[] {}));
