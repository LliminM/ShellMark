package shellmark.util.graph.graphview;
...
public class GraphList extends java.util.Observable {
	...
	public GraphInfo(shellmark.util.newgraph.Graph g,
			 shellmark.util.newgraph.Style s,
			 java.lang.String n) {
	    graph = g;
	    style = s;
	    name = n;
	...
	public shellmark.util.newgraph.Graph graph;
	public shellmark.util.newgraph.Style style;
     ...
     */
    public void add(shellmark.util.newgraph.Graph graph,
		    shellmark.util.newgraph.GraphStyle style,
     ...
     * @param name name of the graph
     */
    public void add(shellmark.util.newgraph.MutableGraph graph,
		    shellmark.util.newgraph.GraphStyle style,
		    java.lang.String name) {
    ...
    public void add(shellmark.util.newgraph.Graph graph,
		    java.lang.String name) {
	shellmark.util.newgraph.GraphStyle style =
	    new shellmark.util.newgraph.EditableGraphStyle();
	add(graph, style.localize(graph), name);
    }
    ...
    // adds a graph to the list of graphs
    private void add(shellmark.util.newgraph.Graph g,
		    shellmark.util.newgraph.Style s, java.lang.String name) {
	boolean found = false;
     ...
     */
    public shellmark.util.newgraph.Graph getGraph(int index) {
     ...
     * @param index index of the graph in the list
     */
    public shellmark.util.newgraph.Style getStyle(int index) {
