 ...
 * which of the classes specified in shellmark.util.classloading.IClassFinder the
...
implements shellmark.util.classloading.IClassFinder {
    ...
    public String getClassShortname(String className) {
        ...
        if(o instanceof shellmark.Algorithm) {
            shellmark.Algorithm algo = 
                (shellmark.Algorithm)o;
    ...
    private static void findFiles(java.io.File dir,Class supers[],
        ...
        for (int i = 0; i < classFiles.length; i++) {
            ...
            try {
                ...
                int ind= className.lastIndexOf("shellmark");
