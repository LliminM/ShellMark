...
/**
 * The shellmark.util.Options class parses command-line options according to
 * the Unix standard (POSIX .2 section 2.10.2) utility syntax guideines.
 * While the end-user sees behavior consistent with the C getpot()
 * function, the programming interface is completely different.
 * 
 * @author LiMin, HunanUniversity
 * @version 9/22
 */

public class Options {
	private int nspecs;      // number of specs,equal size of arrays;
	...
	private StringBuffer seen;  // option letter seen during parsing
	...
	public Options(String[] speclist) {
		...
		for (int i = 0;i < nspecs; i++) {
			java.util.StringTokenizer tk = new java.util.StringTokenizer(speclist[2*i]);
	...
	public void usage(java.io.PrintStream p, String cmdname) {
	...
	private static void test(Options o, String cmdline) {
	    System.out.println();
	    java.util.StringTokenizer tk = new java.util.StringTokenizer(cmdline);
