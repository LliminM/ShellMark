 ...
 * {@link shellmark.util.newgraph.Graphs#createGraph(java.util.Iterator,java.util.Iterator)}.
 *
 * @author LiMin
 * @see shellmark.util.newgraph.MutableGraph
 */
...
public abstract class Graph {
	   ...
	   private java.util.Iterator sortedIterator(java.util.Iterator i,
		 ...
		 a[j++] = i.next();
	      ...
	      return new shellmark.util.ArrayIterator(a, 0, j);
	   }
