...
public class ReduciblePermutationGraph extends AbstractCodec {
	   ...
	   public shellmark.util.newgraph.Graph encode(java.math.BigInteger val,
		 ...
		 shellmark.util.newgraph.Graphs.createGraph(null, null);
	      ...
	      shellmark.util.newgraph.Edge tmp =
		 new shellmark.util.newgraph.EdgeImpl(root, cycleRoot);
	      g = g.addEdge(tmp);
		 ...
		 prev = curr;
	      ...
	      shellmark.util.newgraph.Graph d = g.dominatorTree(root);
	   ...
	   private class Decoder {
		 ...
		 return p;
	      ...
	      public Decoder(shellmark.util.newgraph.Graph g,
...
//	 	       System.err.println("inserting " + from + " in " + (i-1));
	   ...
	   public java.math.BigInteger decode(shellmark.util.newgraph.Graph g)
	      throws DecodeFailure {
		 ...
		 throw new DecodeFailure("not a permutation graph: multiple roots");
	      ...
	      shellmark.util.newgraph.Graph d =
...
//	       System.err.println(p);
	   ...
	   private static java.util.Map getPermutation(java.math.BigInteger value, 
		 ...
		 product = product.multiply(java.math.BigInteger.valueOf(2*i-1));
	      ...
	      java.util.Collection tempcoll = shellmark.util.Math.getCombination(split[0], n, 2*k);
	      if (tempcoll==null)
	   ...
	   private static java.math.BigInteger decodePermutation(java.util.Map p) 
		 ...
		 shellmark.util.Math.decodeCombination(cycleElements.keySet(), n);
