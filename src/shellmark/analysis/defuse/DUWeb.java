...
public class DUWeb extends shellmark.util.newgraph.MutableGraph
implements Comparable,shellmark.util.newgraph.LabeledNode {
...
for(java.util.Iterator it = defs().iterator() ; it.hasNext() ; ) {
	...
	(shellmark.analysis.defuse.DefWrapper)it.next();
    def.setIndex(index);
}
...
public int compare(Object o1,Object o2) {
  ...
  shellmark.analysis.defuse.DefWrapper dw1 =
     (shellmark.analysis.defuse.DefWrapper)o1;
  shellmark.analysis.defuse.DefWrapper dw2 =
     (shellmark.analysis.defuse.DefWrapper)o2;
