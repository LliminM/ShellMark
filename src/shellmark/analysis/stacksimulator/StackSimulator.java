   ...
   implements org.apache.bcel.Constants
{
   ...
   private shellmark.analysis.controlflowgraph.MethodCFG methodCFG;
    ...
    */
   public StackSimulator(shellmark.analysis.controlflowgraph.MethodCFG methodCFG)
   {
   ...
   public StackSimulator(shellmark.program.Method method)
   {
      this(method.getCFG());
   }
   ...
   private Context getInitialContext() {
	   shellmark.program.Method method = methodCFG.method();
   ...
   */
   public shellmark.analysis.stacksimulator.Context getInstructionContext
   ...
   {
	   shellmark.analysis.stacksimulator.Context c =
         (shellmark.analysis.stacksimulator.Context)
   ...
   */
   private void simulate(shellmark.analysis.controlflowgraph.BasicBlock initialBlock,
		   shellmark.analysis.stacksimulator.Context initialIncomingContext) {
      ...
      while(!blockList.isEmpty()){
         ...
         shellmark.analysis.controlflowgraph.BasicBlock block =
            (shellmark.analysis.controlflowgraph.BasicBlock)blockList.removeFirst();
         Context incomingContext = (Context)contextList.removeFirst();


         java.util.ArrayList instList = block.getInstList();
         shellmark.analysis.stacksimulator.Context context = incomingContext;

         shellmark.analysis.stacksimulator.Context startC =
            (shellmark.analysis.stacksimulator.Context)ih2c.get(block);
         ...
         */
         ...
         if (last instanceof org.apache.bcel.generic.RET){
            ...
            while (edgeIter.hasNext()) {
               ...
               if (e instanceof shellmark.analysis.controlflowgraph.ExceptionEdge){
                  continue;
               }

               shellmark.analysis.controlflowgraph.BasicBlock succ =
                  (shellmark.analysis.controlflowgraph.BasicBlock)e.sinkNode();
   ...
   */
   private Context execute(org.apache.bcel.generic.InstructionHandle instH,
                           shellmark.analysis.stacksimulator.Context context)
   {
      ...
      if(inst instanceof org.apache.bcel.generic.ACONST_NULL){
         context = context.push(new shellmark.analysis.stacksimulator.ReferenceData
         ...
         context = doArray(instH, context);
    	  ...
    	  shellmark.analysis.stacksimulator.StackData[] arrays =
         ...
         for(int i = 0; i < arrays.length; i++){
            if(arrays[i] instanceof
            		shellmark.analysis.stacksimulator.ArrayReferenceData){
            	shellmark.analysis.stacksimulator.ArrayReferenceData arr =
                  (shellmark.analysis.stacksimulator.ArrayReferenceData)arrays[i];
               toPush.add(new shellmark.analysis.stacksimulator.IntData
                          (arr.getLength(), instH));
            }
            else det = false;
         }
         if(!det)
            toPush.add(new shellmark.analysis.stacksimulator.IntData(instH));
         context = context.push((shellmark.analysis.stacksimulator.StackData[])
                                toPush.toArray(new shellmark.analysis.stacksimulator.StackData[]{}));
      }
         ...
         context = context.push(new shellmark.analysis.stacksimulator.IntData
         ...
         case JSR_W:{
            ...
            context = context.push
               (new shellmark.analysis.stacksimulator.ReturnaddressData(instH, jsrtarget));
            break;
         }
         }
      }
         ...
         case INSTANCEOF:
            ...
            context = context.push(new shellmark.analysis.stacksimulator.BooleanData(instH));
            break;
         case CHECKCAST:{
         ...
         case MULTIANEWARRAY:
            ...
            shellmark.analysis.stacksimulator.StackData[] lengthSet =
               context.getStackAt(0);
            for(int dimCounter = 0 ; dimCounter < dimension ; dimCounter++)
               context = context.pop();

            shellmark.analysis.stacksimulator.StackData[] arrays =
               new shellmark.analysis.stacksimulator.StackData[lengthSet.length];
            ...
            for(int l = 0; l < arrays.length; l++){
               arrays[l] = new shellmark.analysis.stacksimulator.ArrayReferenceData
                  ((org.apache.bcel.generic.ReferenceType)arraytype,
                   instH, (shellmark.analysis.stacksimulator.PrimitiveData)lengthSet[l]);
            }
         ...
         case LDC_W:
            ...
            if(loadType.equals(org.apache.bcel.generic.Type.INT))
               context = context.push(new shellmark.analysis.stacksimulator.IntData(instH));
            else if(loadType.equals(org.apache.bcel.generic.Type.FLOAT))
               context = context.push(new shellmark.analysis.stacksimulator.FloatData(instH));
            else if(loadType.equals(org.apache.bcel.generic.Type.DOUBLE))
               context = context.push(new shellmark.analysis.stacksimulator.DoubleData(instH));
            else if(loadType.equals(org.apache.bcel.generic.Type.LONG))
               context = context.push(new shellmark.analysis.stacksimulator.LongData(instH));
            else
               context = context.push(new shellmark.analysis.stacksimulator.ReferenceData
         ...
         case GETSTATIC:
            ...
            shellmark.analysis.stacksimulator.StackData toPush =
         ...
         context = context.push(new shellmark.analysis.stacksimulator.DoubleData
         ...
         context = context.push(new shellmark.analysis.stacksimulator.FloatData
         ...
         context = context.push(new shellmark.analysis.stacksimulator.IntData
    	  ...
    	  shellmark.analysis.stacksimulator.StackData [] values2 =
            context.getStackAt(0);
         context = context.pop();
         shellmark.analysis.stacksimulator.StackData [] values1 =
            context.getStackAt(0);
         context = context.pop();
         shellmark.analysis.stacksimulator.StackData [] toPush =
            new shellmark.analysis.stacksimulator.StackData[values2.length * values1.length];
         for(int i1 = 0; i1 < values1.length; i1++){
        	 shellmark.analysis.stacksimulator.PrimitiveData v1 =
               (shellmark.analysis.stacksimulator.PrimitiveData)values1[i1];
            for(int i2 = 0; i2 < values2.length; i2++){
               int index = i1*values2.length + i2;
               shellmark.analysis.stacksimulator.PrimitiveData v2 =
                  (shellmark.analysis.stacksimulator.PrimitiveData)values2[i2];
               if(v1.hasDefinedValue() && v2.hasDefinedValue())
                  toPush[index] = (new shellmark.analysis.stacksimulator.CompositeIntData
                                   (v2, v1,
         ...
         context = context.push(new shellmark.analysis.stacksimulator.LongData
         ...
         if(inst instanceof org.apache.bcel.generic.LoadInstruction){
            try{
               ...
               case ILOAD_2:
               case ILOAD_3:
                  theClass = Class.forName("shellmark.analysis.stacksimulator.IntData");
                  break;
               case DLOAD:
               case DLOAD_0:
               case DLOAD_1:
               case DLOAD_2:
               case DLOAD_3:
                  theClass = Class.forName("shellmark.analysis.stacksimulator.DoubleData");
                  break;
               case FLOAD:
               case FLOAD_0:
               case FLOAD_1:
               case FLOAD_2:
               case FLOAD_3:
                  theClass = Class.forName("shellmark.analysis.stacksimulator.FloatData");
                  break;
               case LLOAD:
               case LLOAD_0:
               case LLOAD_1:
               case LLOAD_2:
               case LLOAD_3:
                  theClass = Class.forName("shellmark.analysis.stacksimulator.LongData");
                  break;
               case ALOAD:
               case ALOAD_0:
               case ALOAD_1:
               case ALOAD_2:
               case ALOAD_3:
            	   shellmark.analysis.stacksimulator.StackData [] temp =
                     context.getLocalVariableAt(varIndex);
                  if(temp == null){
                     
                     //                     System.out.println("!!!!!!! Cannot determine local variable type!!!!!!!!!");
                     
                     toPush = new shellmark.analysis.stacksimulator.StackData[]{
                        new shellmark.analysis.stacksimulator.ReferenceData
                     ...
                     for(int i = 0; i < temp.length; i++){
                        if(temp[i] instanceof
                        		shellmark.analysis.stacksimulator.ArrayReferenceData){
                        	shellmark.analysis.stacksimulator.ArrayReferenceData ard =
                              (shellmark.analysis.stacksimulator.ArrayReferenceData)temp[i];
                           data.add(new shellmark.analysis.stacksimulator.ArrayReferenceData
                                    ((org.apache.bcel.generic.ReferenceType)
                                     ard.getType(), ard.getLength(), instH));
                        } else if(temp[i] instanceof
                        		shellmark.analysis.stacksimulator.ReferenceData) {
                           data.add(new shellmark.analysis.stacksimulator.ReferenceData
                                    ((org.apache.bcel.generic.ReferenceType)
        	 ...
        	 shellmark.analysis.stacksimulator.StackData [] top =
               context.getStackAt(0);
            int i = 0;
            try{
               context = context.pop();
               Class theClass = null;
               shellmark.analysis.stacksimulator.StackData [] toStore =
                  new shellmark.analysis.stacksimulator.StackData [top.length];
               switch(opcode){
               case ISTORE:
               case ISTORE_0:
               case ISTORE_1:
               ...
               default:
                  for(i = 0; i < toStore.length; i++){
                     if(top[i] instanceof shellmark.analysis.stacksimulator.ArrayReferenceData){
                        toStore[i] = new shellmark.analysis.stacksimulator.ArrayReferenceData
                           ((org.apache.bcel.generic.ReferenceType)top[i].getType(), instH,
                            ((shellmark.analysis.stacksimulator.ArrayReferenceData)top[i]).getLengthData());
                     }
                     else if (top[i] instanceof shellmark.analysis.stacksimulator.ReferenceData) {
                        toStore[i] = new shellmark.analysis.stacksimulator.ReferenceData
                           ((org.apache.bcel.generic.ReferenceType)top[i].getType(), instH);
                     }
                     else /* ReturnaddressData */ {
                        ReturnaddressData rad = (ReturnaddressData)top[i];
                        toStore[i] = new shellmark.analysis.stacksimulator.ReturnaddressData(instH, rad.getTarget());
                     }
                  }
               ...
               for(i = 0; i < toStore.length; i++){
            	   shellmark.analysis.stacksimulator.PrimitiveData num =
                     (shellmark.analysis.stacksimulator.PrimitiveData)top[i];
                  ...
                  toStore[i] = (shellmark.analysis.stacksimulator.StackData)fact.newInstance(args);
               }
               context = context.replaceVariable(toStore, varIndex);
            }
            catch(Exception e){
        	 ...
        	 shellmark.analysis.stacksimulator.StackData [] toInc =
               context.getLocalVariableAt(varIndex);
        	 shellmark.analysis.stacksimulator.StackData [] toPush = null;
            if(toInc == null)
               context = context.replaceVariable(new shellmark.analysis.stacksimulator.IntData
                                                 (instH), varIndex);
            else{
               toPush = new shellmark.analysis.stacksimulator.StackData[toInc.length];
               for(int i = 0; i < toInc.length; i++){
            	   shellmark.analysis.stacksimulator.PrimitiveData num =
                     (shellmark.analysis.stacksimulator.PrimitiveData)toInc[i];
                  if(num.hasDefinedValue()){
                     toPush[i] = new shellmark.analysis.stacksimulator.CompositeIntData
		   ...
		   shellmark.analysis.stacksimulator.Context context)
   {
      ...
      shellmark.analysis.stacksimulator.StackData[] data;
      shellmark.analysis.stacksimulator.StackData[] data2 = null;
      ...
      case DUP2_X1:
         ...
         shellmark.analysis.stacksimulator.StackData[] skip =
      ...
      case DUP2_X2:
         ...
         if(data[0].getSize() > 1) {
            ...
            shellmark.analysis.stacksimulator.StackData[] filler1 =
      ...
      case POP2:
         ...
         break;
      case SWAP:
    	  shellmark.analysis.stacksimulator.StackData[] data1 =
            context.getStackAt(0);
         data2 = context.getStackAt(1);
		   ...
		   shellmark.analysis.stacksimulator.Context context)
   {
      ...
      if(opcode == DNEG || opcode == FNEG || opcode == INEG || opcode == LNEG){
    	  shellmark.analysis.stacksimulator.StackData [] op1 = context.getStackAt(0);
    	  shellmark.analysis.stacksimulator.StackData [] result =
            new shellmark.analysis.stacksimulator.StackData[op1.length];
         context = context.pop();
         for(int o1 = 0; o1 < op1.length; o1++){
        	 shellmark.analysis.stacksimulator.PrimitiveData arg1 =
               (shellmark.analysis.stacksimulator.PrimitiveData)op1[o1];

            switch(opcode){
            case DNEG: //double negation
               if(arg1.hasDefinedValue())
                  result[o1] = new shellmark.analysis.stacksimulator.CompositeDoubleData
            ...
            case FNEG: //float negation
               if(arg1.hasDefinedValue())
                  result[o1] = new shellmark.analysis.stacksimulator.CompositeFloatData
            ...
            case INEG: //int negation
               if(arg1.hasDefinedValue())
                  result[o1] = new shellmark.analysis.stacksimulator.CompositeIntData
            ...
            case LNEG: //long negation
               if(arg1.hasDefinedValue())
                  result[o1] = new shellmark.analysis.stacksimulator.CompositeLongData
         ...
         context = context.push(result);
    	  ...
    	  shellmark.analysis.stacksimulator.StackData [] op2 = context.getStackAt(0);
         context = context.pop();
         shellmark.analysis.stacksimulator.StackData [] op1 = context.getStackAt(0);
         context = context.pop();

         shellmark.analysis.stacksimulator.StackData [] result =
            new shellmark.analysis.stacksimulator.StackData[op1.length * op2.length];

         for(int o1 = 0; o1 < op1.length; o1++){
        	 shellmark.analysis.stacksimulator.PrimitiveData arg1 =
               (shellmark.analysis.stacksimulator.PrimitiveData)op1[o1];
            for(int o2 = 0; o2 < op2.length; o2++){
            	shellmark.analysis.stacksimulator.PrimitiveData arg2 =
                  (shellmark.analysis.stacksimulator.PrimitiveData)op2[o2];
               ...
               case DADD: //add doubles
                  if(arg1.hasDefinedValue() && arg2.hasDefinedValue()){
                     ...
                     if (got){
                        result[resIndex] =
                           new shellmark.analysis.stacksimulator.CompositeDoubleData
               ...
               case FADD: //add floats
                  if(arg1.hasDefinedValue() && arg2.hasDefinedValue()){
                     ...
                     if (got){
                        result[resIndex] =
                           new shellmark.analysis.stacksimulator.CompositeFloatData
                           (arg1, arg2, value, instH);
                     }else{
                        result[resIndex] =
                           new shellmark.analysis.stacksimulator.CompositeFloatData
               ...
               case IADD: //integer add
                  if(arg1.hasDefinedValue() && arg2.hasDefinedValue())
                     result[resIndex] =
                        new shellmark.analysis.stacksimulator.CompositeIntData
               ...
               case LADD: //long add
                  if(arg1.hasDefinedValue() && arg2.hasDefinedValue())
                     result[resIndex] =
                        new shellmark.analysis.stacksimulator.CompositeLongData
		   ...
		   shellmark.analysis.stacksimulator.Context context)
   {
      ...
      shellmark.analysis.stacksimulator.StackData [] values = context.getStackAt(0);
      context = context.pop();
      shellmark.analysis.stacksimulator.StackData [] toPush =
         new shellmark.analysis.stacksimulator.StackData [values.length];

      for(int v = 0; v < values.length; v++){
    	  shellmark.analysis.stacksimulator.PrimitiveData arg =
            (shellmark.analysis.stacksimulator.PrimitiveData)values[v];
         switch(opcode){
         case D2F:
         case L2F:
         case I2F:
            if(arg.hasDefinedValue())
               toPush[v] = new shellmark.analysis.stacksimulator.CompositeFloatData
         ...
         case L2I:
            if(arg.hasDefinedValue())
               toPush[v] = new shellmark.analysis.stacksimulator.CompositeIntData
         ...
         case I2L:
            if(arg.hasDefinedValue())
               toPush[v] = new shellmark.analysis.stacksimulator.CompositeLongData
         ...
         case L2D:
            if(arg.hasDefinedValue())
               toPush[v] = new shellmark.analysis.stacksimulator.CompositeDoubleData
		   ...
		   shellmark.analysis.stacksimulator.Context context)
   {
      ...
      case SALOAD:
         context = context.pop();
         context = context.pop();
         context = context.push(new shellmark.analysis.stacksimulator.IntData(ih));
         break;
      case DALOAD:
         context = context.pop();
         context = context.pop();
         context = context.push(new shellmark.analysis.stacksimulator.DoubleData(ih));
         break;
      case FALOAD:
         context = context.pop();
         context = context.pop();
         context = context.push(new shellmark.analysis.stacksimulator.FloatData(ih));
         break;
      case LALOAD:
         context = context.pop();
         context = context.pop();
         context = context.push(new shellmark.analysis.stacksimulator.LongData(ih));
         break;
      case AASTORE:
      case BASTORE:
      case CASTORE:
   ...
   private Context doComparison(shellmark.analysis.stacksimulator.Context context,
                                ...
                                org.apache.bcel.generic.InstructionHandle instH)
   {
      ...
      */
	   ...
	   shellmark.analysis.stacksimulator.StackData [] value1 =
         context.getStackAt(0);
      context = context.pop();
      shellmark.analysis.stacksimulator.StackData [] value2 =
         context.getStackAt(0);
      context = context.pop();
      shellmark.analysis.stacksimulator.StackData [] toPush =
         new shellmark.analysis.stacksimulator.StackData
         [value1.length * value2.length];

      for(int i1 = 0; i1 < value1.length; i1++){
    	  shellmark.analysis.stacksimulator.PrimitiveData v1 =
            (shellmark.analysis.stacksimulator.PrimitiveData)value1[i1];
         for(int i2 = 0; i2 < value2.length; i2++){
        	 shellmark.analysis.stacksimulator.PrimitiveData v2 =
               (shellmark.analysis.stacksimulator.PrimitiveData)value2[i2];
            ...
            if(v1.hasDefinedValue() && v2.hasDefinedValue()){
               if(v1.getValue().equals(NaNValue) ||
                  ...
                  toPush[index] = new
                		  shellmark.analysis.stacksimulator.CompositeIntData
   ...
   private shellmark.analysis.stacksimulator.StackData getDataForType
       ...
       org.apache.bcel.generic.InstructionHandle ih)
   {
      if (dataType instanceof org.apache.bcel.generic.ArrayType){
         ...
         return new shellmark.analysis.stacksimulator.ReferenceData
         ...
         return new shellmark.analysis.stacksimulator.IntData(ih);
      else if(dataType.equals(org.apache.bcel.generic.Type.LONG))
         return new shellmark.analysis.stacksimulator.LongData(ih);
      else if(dataType.equals(org.apache.bcel.generic.Type.FLOAT))
         return new shellmark.analysis.stacksimulator.FloatData(ih);
      else if(dataType.equals(org.apache.bcel.generic.Type.DOUBLE))
         return new shellmark.analysis.stacksimulator.DoubleData(ih);
      else
         throw new IllegalArgumentException(dataType + "is not a valid type.");
   }

   private static void apply(shellmark.program.Application app) throws Exception
   {
      java.util.Iterator classItr = app.classes();
      while(classItr.hasNext()){
    	  shellmark.program.Class cls = (shellmark.program.Class)classItr.next();
   ...
   public static void apply(shellmark.program.Method method, int index) {
   ...
   public static void main(String[] args) throws Exception
   {
      ...
      try{
    	  shellmark.program.Application app =
            new shellmark.program.Application(args[0]);
         if(args.length >= 4){
            int index=-1;
            if (args.length>4)
   ...
   private shellmark.analysis.stacksimulator.StackData [] doLoad
      (shellmark.analysis.stacksimulator.StackData[] temp,
       ...
       org.apache.bcel.generic.InstructionHandle instH)
   {
      ...
      try{
         if(temp == null){
            toPush = new shellmark.analysis.stacksimulator.StackData []{
               (shellmark.analysis.stacksimulator.StackData)
               withOutValue.newInstance(new Object[]{instH})
            };
         }else{
            toPush = new shellmark.analysis.stacksimulator.StackData[temp.length];
