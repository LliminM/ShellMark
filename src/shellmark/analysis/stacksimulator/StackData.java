...
private shellmark.analysis.stacksimulator.PrimitiveData theLengthData;

public ArrayReferenceData(org.apache.bcel.generic.ReferenceType ref,
                          org.apache.bcel.generic.InstructionHandle h,
                          shellmark.analysis.stacksimulator.PrimitiveData length)
{
   super(ref, h);
                          ...
                          org.apache.bcel.generic.InstructionHandle h)
{
   super(ref, h);
   myLength = length;
   theLengthData = new shellmark.analysis.stacksimulator.IntData(length, h);
}
...
shellmark.analysis.stacksimulator.PrimitiveData getLengthData()
{
...
{
private shellmark.analysis.stacksimulator.PrimitiveData myOp1;
private shellmark.analysis.stacksimulator.PrimitiveData myOp2;

public CompositeIntData(shellmark.analysis.stacksimulator.PrimitiveData op1,
		shellmark.analysis.stacksimulator.PrimitiveData op2,
                        org.apache.bcel.generic.InstructionHandle h)
{
   super(h);
   myOp1 = op1;
...
public shellmark.analysis.stacksimulator.PrimitiveData getOp1()
{
   return myOp1;
}

public shellmark.analysis.stacksimulator.PrimitiveData getOp2()
{
   return myOp2;
}
...
public CompositeBooleanData(shellmark.analysis.stacksimulator.PrimitiveData op1,
		shellmark.analysis.stacksimulator.PrimitiveData op2,
                            org.apache.bcel.generic.InstructionHandle h)
{
   super(h);
...
public CompositeLongData(shellmark.analysis.stacksimulator.PrimitiveData op1,
		shellmark.analysis.stacksimulator.PrimitiveData op2,
                         org.apache.bcel.generic.InstructionHandle h)
{
   super(h);
...
public CompositeDoubleData(shellmark.analysis.stacksimulator.PrimitiveData op1,
		shellmark.analysis.stacksimulator.PrimitiveData op2,
                           org.apache.bcel.generic.InstructionHandle h)
{
   super(h);
...
public CompositeFloatData(shellmark.analysis.stacksimulator.PrimitiveData op1,
		shellmark.analysis.stacksimulator.PrimitiveData op2,
                          org.apache.bcel.generic.InstructionHandle h)
{
   super(h);
